...
const ImportPreviewStep = ({ file, columnMapping, onPreviewComplete, onBack }) => {
  ...
  const loadPreview = async () => {
    ...
    try {
      ...
      const response = await authFetch(`${API_BASE_URL}/api/crm/upload/preview-import`, {
        method: 'POST',
        body: formData
      });
  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-gray-600">
          Review how your data will be imported. Check that everything looks correct before proceeding.
        </p>
      </div>
      ...
      <div className="bg-blue-50 rounded-lg p-4">
        ...
        <div className="text-sm text-blue-800 space-y-1">
          <div>• Duplicate emails will be skipped</div>
          <div>• Rows with missing required data will be skipped</div>
